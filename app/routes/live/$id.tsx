import { AspectRatio, Avatar, Box, Button, Image, Flex, SimpleGrid, Link } from '@chakra-ui/react'
...
import { MetaFunction, LinksFunction } from '@remix-run/react/routeModules'
          ...
          >
            <Box>
              <Box marginBottom="24px">
                <Box color="white">공연명</Box>
                <Box backgroundColor="blackAlpha.100" padding="8px">
                  {live.title}
                </Box>
              </Box>
              <Box marginBottom="24px">
                <Box color="white">공연장소</Box>
                <Box backgroundColor="blackAlpha.100" padding="8px">
